...
// Copied into parsegen by Dan Ibanez as a stopgap until C++17 can be relied on
// Changed to namespace parsegen to prevent conflicts with other versions
...
inline void swap(parsegen::any& lhs, parsegen::any& rhs) noexcept {
  lhs.swap(rhs);
}
